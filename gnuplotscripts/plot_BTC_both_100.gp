# File overview: gnuplotscripts/plot_BTC_both_100.gp is part of the PETSc_test simulation/analysis workflow.
# plot_BTC_combined.gp
# Generates plots with linear main plot and log inset
# Modified for 100 realizations
...
plot 'x=0.50BTC_Compare.csv' using 1:2 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     ...
     'x=0.50BTC_Compare.csv' using 201:202 with lines lw 3 lc rgb "#FF0000" title 'Upscaled'
...
plot 'x=0.50BTC_Compare.csv' using 1:2 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     ...
     '' using 195:196 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     '' using 197:198 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     '' using 199:200 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     'BTC_mean.csv' using 1:2 with lines lw 2 lc rgb "#000000" notitle, \
     'x=0.50BTC_Compare.csv' using 201:202 with lines lw 2 lc rgb "#FF0000" notitle
...
plot 'x=1.50BTC_Compare.csv' using 1:2 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     ...
     'x=1.50BTC_Compare.csv' using 201:202 with lines lw 3 lc rgb "#FF0000" title 'Upscaled'
...
plot 'x=1.50BTC_Compare.csv' using 1:2 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     ...
     'x=1.50BTC_Compare.csv' using 201:202 with lines lw 2 lc rgb "#FF0000" notitle
...
plot 'x=2.50BTC_Compare.csv' using 1:2 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     ...
     'x=2.50BTC_Compare.csv' using 201:202 with lines lw 3 lc rgb "#FF0000" title 'Upscaled'
...
plot 'x=2.50BTC_Compare.csv' using 1:2 with lines lw 1 lc rgb "#CCCCCC" notitle, \
     ...
     'x=2.50BTC_Compare.csv' using 201:202 with lines lw 2 lc rgb "#FF0000" notitle

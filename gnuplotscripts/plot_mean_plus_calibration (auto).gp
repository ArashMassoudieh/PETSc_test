# File overview: gnuplotscripts/plot_mean_plus_calibration (auto).gp is part of the PETSc_test simulation/analysis workflow.
#!/usr/bin/gnuplot
...
do for [X in Xvals] {
    ...
    set output outfile
    set title sprintf("BTC Mean (black) + Calibration (red)  |  %s %s %s  |  x = %s", STD_TAG, D_TAG, ANISO_TAG, X) font "Arial,32"

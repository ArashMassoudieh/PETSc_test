# File overview: gnuplotscripts/plot_K_correlations.gp is part of the PETSc_test simulation/analysis workflow.
#!/usr/bin/gnuplot
...
plot 'K_x_correlations.txt' every ::1 u 1:2  w l ls 1 notitle, \
     ...
     'K_x_correlations_mean.txt'                           u 1:2 w lp ls 2 pt 6 ps 0.45 title 'Mean', \
     'K_x_correlations_mean_fitted.txt' u 1:2 w l  ls 3          title 'Exponential fit'
...
plot 'K_y_correlations.txt' every ::1 u 1:2  w l ls 1 notitle, \
     ''                                                    every ::1 u 3:4  w l ls 1 notitle, \
     ''                                                    every ::1 u 5:6  w l ls 1 notitle, \
     ''                                                    every ::1 u 7:8  w l ls 1 notitle, \
     ''                                                    every ::1 u 9:10 w l ls 1 notitle, \
     ...
     ''                                                    every ::1 u 37:38 w l ls 1 notitle, \
     ''                                                    every ::1 u 39:40 w l ls 1 title 'Realizations', \
     'K_y_correlations_mean.txt'        u 1:2 w lp ls 2 pt 6 ps 0.45 title 'Mean', \
     'K_y_correlations_mean_fitted.txt' u 1:2 w l  ls 3          title 'Exponential fit'

...
CMatrix_arma::CMatrix_arma(int r, int c) : arma::mat(r, c, arma::fill::zeros) {}
...
CMatrix_arma& CMatrix_arma::operator=(const arma::mat& other) {
    arma::mat::operator=(other);
    return *this;
}
...
CMatrix_arma& CMatrix_arma::operator+=(const CMatrix_arma& rhs) {
    *this += static_cast<const arma::mat&>(rhs);
    return *this;
}
...
CMatrix_arma Identity_ar(int n) {
    return CMatrix_arma(arma::eye<arma::mat>(n, n));
}
